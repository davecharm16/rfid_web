  ...
  return (
    ...
    >
      <Box display='flex' alignItems='center'>
        <Typography variant='h5' mx='10px' color = '#02B566' fontWeight='bold'>PayMaya Details</Typography>
        <TextField label='Your PayMaya No.' type='text' sx = {{
          '& .MuiInputLabel-root'  : {
            fontWeight : 'bold',
            color : '#02B566',
          }
